...
const int tinyfont_count = 45;
unsigned const int PROGMEM mytinyfont[45][4] = {
...
const int bells_count = 1;
unsigned const int PROGMEM mybell[1][8] = {
  { 0, 0x01, 0x0F, 0x11, 0x11, 0x0F, 0x01, 0x00 }
}; 
